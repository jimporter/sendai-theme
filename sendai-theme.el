...
(sendai-let-palette
  (custom-theme-set-faces
   ...
   ;; transient
   `(transient-heading ,(sendai-face :foreground yellow-primary :weight 'bold))
   `(transient-key ,(sendai-face :inherit 'help-key-binding))
   `(transient-separator ,(sendai-face :background fg-darker))
   `(transient-higher-level ,(sendai-face :underline t))
   `(transient-active-infix ,(sendai-face :background yellow-light))
   `(transient-enabled-suffix ,(sendai-face :background green-light))
   `(transient-disabled-suffix ,(sendai-face :background red-primary))
   `(transient-inapt-suffix ,(sendai-face :inherit 'shadow :slant 'italic))
   `(transient-argument ,(sendai-face :foreground orange-light))
   `(transient-value ,(sendai-face :foreground green-light))
   `(transient-inactive-argument ,(sendai-face :inherit 'shadow))
   `(transient-inactive-value ,(sendai-face :inherit 'shadow))
   `(transient-mismatched-key ,(sendai-face :underline t))
   `(transient-nonstandard-key ,(sendai-face :underline t))
   `(transient-unreachable ,(sendai-face :inherit 'shadow))
   `(transient-unreachable-key ,(sendai-face :inherit 'shadow))
   `(transient-amaranth ,(sendai-face :foreground magenta-primary))
   `(transient-blue ,(sendai-face :foreground blue-primary))
   `(transient-pink ,(sendai-face :foreground magenta-light))
   `(transient-purple ,(sendai-face :foreground violet-primary))
   `(transient-red ,(sendai-face :foreground red-primary))
   `(transient-teal ,(sendai-face :foreground cyan-primary))
